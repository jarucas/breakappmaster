...
/**
 * Created by Javier on 22/08/2018.
 *
 * Extension of {@link android.support.design.widget.BottomSheetBehavior} in order to control the
 * methods related to the user actions: The user will not be able to drag the sheet.
 */
